...
class Connector(object):
    ...
    def get_data(self):
        '''return json dumps'''
        return dumps(self.data.find())
    def get_header(self):
        '''return config columns'''
        return dumps(self.data.find_one().keys())
    def get_config(self):
        '''return config for js'''
        return
    ...
    def build_schema(self):
        ...
        if self.db_type == "db":
            ...
            #retrieve from mongo initial SQL schema
            self.schema = self.to_cursor["schema"]
        return self.schema
    ...
    def select_tables(self):
        ...
        if self.db_type == "db":
            ...
            self.tables = self.data.find_one().keys()
        return self.tables
